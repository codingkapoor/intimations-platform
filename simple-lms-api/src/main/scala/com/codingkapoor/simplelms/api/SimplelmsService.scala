package com.codingkapoor.simplelms.api
...
object SimplelmsService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The simple-lms service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the SimplelmsService.
  */
trait SimplelmsService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("simple-lms")
      ...
      .withTopics(
        topic(SimplelmsService.TOPIC_NAME, greetingsTopic _)

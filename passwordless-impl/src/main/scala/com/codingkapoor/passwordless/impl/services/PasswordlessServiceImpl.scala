...
import com.codingkapoor.passwordless.impl.repositories.otp.{OTPDao, OTPEntity}
import com.codingkapoor.passwordless.impl.repositories.token.{RefreshTokenDao, RefreshTokenEntity}
